...
const AppNotification = ({
  ...
  return (
    <motion.div
      ...
      className="px-4 transition-all absolute left-16  w-72 min-h-12 flex flex-row items-center justify-between rounded shadow-md z-30"
      style={{
    ...
    >
      <div className="w-full rounded-lg flex flex-row items-center justify-start gap-2">
        {renderIcon()}
        <p
          style={{
            color: colors.text,
